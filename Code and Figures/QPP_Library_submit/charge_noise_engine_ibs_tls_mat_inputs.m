...
%--------------------------------------%
% Adapated from charge_noise_engine_ibs_tls for specifically a two level system. 
% Here the eigenvectors and eigenvalues are input directly, which allows
% them to saved externally. This will significantly speed up time. 
%
...
function [X_exp, Z_exp, Y_exp, ...
    ...
    e_vals_2, e_vecs_2_init_b, e_vals_2_init_b, majorana_zero_modes_ref, ...
    mu_vec_no_off, mu_offset, mu_low, mu_high, init_state, delta_t, ...
    t_init, t_final, basis_choice)

%(mu_low, mu_high, mu_offset, w, delta, N, BC, t_init, t_final,...
%     delta_t, mu_vec_no_off, basis_choice, init_state)  
    ...
    [Z_exp, X_exp, Y_exp, P_y1y2y3y4, ~, overlap_with_init_state, ...
        ...
        overlap_inst_basis_states] =...
        calc_noisy_tetron_ev_ibs_tls_lean(...
